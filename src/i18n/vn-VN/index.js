export default {
  ...
  ILIKE: 'Giống',
  'WebGIS Bus Stop Da Nang': 'WebGIS Trạm Xe Buýt Đà Nẵng',
  'Vietname boundary': 'Ranh giới Việt Nam',
  'Danang boundary': 'Ranh giới Đà Nẵng',
  'Bus stop': 'Trạm xe buýt',
  'Search bus stop': 'Tìm kiếm trạm xe',
  'Add bus stop': 'Thêm trạm xe',
  'Update bus stop': 'Sửa trạm xe',
  'Delete bus stop': 'Xóa trạm xe',
  'Enter bus stop name': 'Nhập tên trạm xe',
  'Add new bus stop': 'Thêm trạm xe mới',
  'Bus stop name': 'Tên trạm xe',
  'Select a location on the map by clicking the "Select location" button':
    'Chọn vị trí trên bản đồ bằng cách nhấn nút "Chọn vị trí"',
  'Edit bus stop information': 'Chỉnh sửa thông tin trạm xe',
  'Are you sure you want to delete this bus stop?': 'Bạn có chắc chắn muốn xóa trạm xe này không?',
  'No name': 'Không có tên',
  'No description': 'Không có mô tả',
  'No bus stop found with name containing "': 'Không tìm thấy trạm xe nào có tên chứa "',
  'Error adding bus stop': 'Lỗi thêm trạm xe',
  'Error updating bus stop': 'Lỗi cập nhật trạm xe',
  'Error deleting bus stop': 'Lỗi xóa trạm xe',
  'Error loading data': 'Lỗi tải dữ liệu',
  'Error searching': 'Lỗi tìm kiếm',
  Search: 'Tìm',
}
